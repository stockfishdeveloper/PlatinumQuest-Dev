...
- `TERRAIN_LR_MULT = 1.0` (off). A 4x run on 2026-09-13 grew the actor's terrain columns to parity with the critic without improving OOB and doubled KL; the mechanism stays available via `--terrain-lr-mult`.
