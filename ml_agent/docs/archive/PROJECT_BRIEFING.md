> **ARCHIVED 2026-09-18.** Written 2026-03-02, before both the edge-shaping work and the
> navigator architecture. Kept for background only; for the current design see
> `../../ROADMAP_NAVIGATOR_PLANNER.md` and `../../HANDOFF_NAV_TRAINING.md`.
