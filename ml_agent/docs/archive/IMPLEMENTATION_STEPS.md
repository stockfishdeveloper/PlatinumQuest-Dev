> **ARCHIVED 2026-09-18.** Step-by-step for the edge-shaping work on the old `train_ppo.py`
> agent. It references `ml_agent/edge_maps/`, which was DELETED on 2026-09-18; the navigator
> ray-marches edge features live from `terrain_maps/terrain_<map>.npz` instead. See
> `HANDOFF_EDGE_SHAPING.md` next to this file, and `../../HANDOFF_NAV_TRAINING.md`.
