#!/bin/bash
# 2026-09-23 08:57 operator: keep 1x watch games running on the parity1 checkpoint (131.5) until told to stop.
...
while true; do
  ...
  powershell.exe -NoProfile -ExecutionPolicy Bypass -File ./real_run.ps1 -Map KingOfTheMarble_Hunt -Rounds 200 -Ckpt models/nav/nav_best_parity1_19640.pth
