...
echo "$(date +%H:%M:%S) reached $upd, running eval_cycle -Tag timeprice2 -Rounds 8"
powershell.exe -NoProfile -ExecutionPolicy Bypass -File ./eval_cycle.ps1 -Tag timeprice2 -Rounds 8
